...
var sendSms = function(teles, msg) {
  var url = 'http://kfd.shangyoo.com/game_send_msg?game_id=20&teles='
          + teles.toString() + '&msg=' + encodeURIComponent(msg) + '&max_num=3000'
  ...
  'order': {
    ...
    'func3' : function (orders, cb) {
      if (common.sms) {
        ...
        var content = '(元气骑士)' + keys + '在' + getTime() + '下单失败'
  ...
  'thirdCallback': {
    ...
    'func3' : function (tcs, cb) {
      if (common.sms) {
        ...
        var content = '元气骑士' + keys.toString() + '在' + getTime() + '回调失败'
        sendSms(common.smsList, content)
      }
      cb('ok', tcs)
    }
  ...
  'deliverGoods': {
    ...
    'func3' : function (dgu, cb) {
      if (common.sms) {
        ...
        var content = '元气骑士在' + getTime() + '发货失败'
        sendSms(common.smsList, content)
      }
      cb('ok', dgu)
    }
